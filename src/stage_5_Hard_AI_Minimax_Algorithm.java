...
public class stage_5_Hard_AI_Minimax_Algorithm {
    ...
    static void hardMove(char aiPlayer) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                if (board[i][j] == ' ') {
                    board[i][j] = aiPlayer;
                    int score = minimax(false, aiPlayer, opponent);
                    board[i][j] = ' ';
    ...
    static int minimax(boolean isMaximizing, char aiPlayer, char opponent) {
        ...
        if (isMaximizing) {
            ...
            for (int i = 0; i < 3; i++) {
                for (int j = 0; j < 3; j++) {
                    if (board[i][j] == ' ') {
                        board[i][j] = opponent;
                        int score = minimax(true, aiPlayer, opponent);
                        board[i][j] = ' ';
